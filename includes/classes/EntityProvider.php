<?php
    class EntityProvider {
        ...
        public static function getTvShows($conn, $categoryId, $limit) {
        ...
        public static function getMovies($conn, $categoryId, $limit) {
            $sql = "SELECT DISTINCT(entities.id) FROM entities INNER JOIN videos ON entities.id = videos.entityId
        ...
        public static function getSearchEntities($conn, $search) {
